                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-info edit" href="{{route('member.edit',$detail->id)}}" title="Edit">Edit</a>
                        <form method= "post" action="{{route('member.destroy',$detail->id)}}" class="delete btn  btn-danger">
                          {{csrf_field()}}
