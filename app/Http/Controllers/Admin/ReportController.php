...
class ReportController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('report.index')->with('message','Blog Deleted Successfully');
    }
