...
{
    public function __construct(SchemeRepository $scheme){
        $this->scheme=$scheme;
    }
    /**
    ...
    {
        $details=$this->scheme->orderBy('created_at','desc')->get();
        // dd($details);
        return view('admin.scheme.list',compact('details'));
    }
    ...
    {   
        ...
        $this->scheme->create($value);
        return redirect()->route('scheme.index')->with('message','Blog Added Successfully');
    }
    ...
    {
        $detail=$this->scheme->find($id);
        return view('admin.scheme.edit',compact('detail'));   
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->scheme->update($value,$id);
        return redirect()->route('scheme.index')->with('message','Blog Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $this->scheme->destroy($id);
        return redirect()->route('scheme.index')->with('message','Blog Deleted Successfully');
    }
